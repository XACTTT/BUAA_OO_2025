...
public class Unit {
    ...
    public Poly difftri(Poly poly, String type) {
        ...
        if (type.equals("sin")) {
            ...
            Unit unit = new Unit(this.coe, this.vs
            ...
            HashMap<String, Integer> emptyVS = new HashMap<>();
            Unit diffUnit = new Unit(BigInteger.valueOf(pow), emptyVS, newSinMap, newCosMap);
